...
const StevenGJohnsonGitHubProfile  = () => {
  return (
    <div>
     ...
     <div className="d-flex color-bg-subtle rounded-1 flex-justify-between p-3">
        <div className="d-flex">
           ...
           */}
          <img 
  src="https://avatars.githubusercontent.com/u/2913679?v=4" 
...
export default StevenGJohnsonGitHubProfile;
